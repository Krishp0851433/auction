...
Congratulations! The auction for your item '$itemName', has completed with a winning bid of $currency $winnerAmt bidded by 
{$winnerName}!
Bid details:

Item: $itemName
Amount: $currency $winnerAmt
Winner bidder: $winnerName ({$winnerEmail})
